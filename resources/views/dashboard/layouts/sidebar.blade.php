        ...
        <nav class="sidebar-nav">
            <ul class="nav">
                ...
                <li class="nav-title">
                 ...
                 <li class="nav-item">
                    <a class="nav-link" href="{{route('dashboard.create_user')}}"><i class="icon-user-follow"></i>{{trans('words.add_user')}}</a>
                    <a class="nav-link" href="{{route('dashboard.show_user')}}"><i class="icon-people"></i>{{trans('words.user')}}</a>
                </li>
