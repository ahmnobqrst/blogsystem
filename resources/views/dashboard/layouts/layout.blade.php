            ...
            <ul class="nav navbar-nav pull-left hidden-md-down">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                        <img src="{{asset('asset/img/avatars/6.jpg')}}" class="img-avatar" alt="admin@bootstrapmaster.com">
                ...
                <div class="callout callout-danger m-a-0 p-y-1">
                    ...
                    <div class="avatars-stack m-t-h">
                        <div class="avatar avatar-xs">
                            <img src="{{asset('asset/img/avatars/2.jpg')}}" class="img-avatar" alt="admin@bootstrapmaster.com">
                        </div>
                        <div class="avatar avatar-xs">
                            <img src="{{asset('asset/img/avatars/3.jpg')}}" class="img-avatar" alt="admin@bootstrapmaster.com">
                        </div>
                        <div class="avatar avatar-xs">
                            <img src="{{asset('asset/img/avatars/4.jpg')}}" class="img-avatar" alt="admin@bootstrapmaster.com">
                        </div>
                        <div class="avatar avatar-xs">
                            <img src="{{asset('asset/img/avatars/5.jpg')}}" class="img-avatar" alt="admin@bootstrapmaster.com">
                        </div>
                        <div class="avatar avatar-xs">
                            <img src="{{asset('asset/img/avatars/6.jpg')}}" class="img-avatar" alt="admin@bootstrapmaster.com">
                        </div>
